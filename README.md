...
当前版本：[v0.1.3](https://github.com/wonly211/RASharp/releases/tag/v0.1.3)
...
- [自包含单文件版](https://github.com/wonly211/RASharp/releases/download/v0.1.3/RASharp-v0.1.3-win-x64-self-contained.exe)：无需安装 .NET，直接运行。
- [框架依赖单文件版](https://github.com/wonly211/RASharp/releases/download/v0.1.3/RASharp-v0.1.3-win-x64-framework-dependent.exe)：需要安装 .NET 10 Desktop Runtime x64。
- [SHA-256 校验文件](https://github.com/wonly211/RASharp/releases/download/v0.1.3/SHA256SUMS.txt)。
